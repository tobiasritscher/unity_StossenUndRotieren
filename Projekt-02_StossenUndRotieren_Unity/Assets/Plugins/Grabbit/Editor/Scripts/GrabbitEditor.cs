...
namespace Grabbit
{
    public class GrabbitEditor : EditorWindow
    {
        ...
        {
            GUIHelper.DisplayMessage("<b> Experimental Mode, use with caution!</b>");
        ...
        private bool DisplayPreferenceParams()
        {
            ...
            modif = modif || GUIHelper.DisplayBoolOption("Use Existing Predefined Colliders",
                ...
                "use only the colliders that you set up on your objects, and no not use generated colliders");
